...
class Dinosaur{
  ...
  roar(){
    return `The ${this.species} says RAWERSRARARWERSARARARRRR!`
  }
};
...
*/
zooAnimals.forEach( currentValue => console.log(currentValue.animal_name +" "+currentValue.scientific_name));
